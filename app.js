...
const STORAGE_KEY = 'ak-h1-progress';
...
const CORRECT_MSGS = [
  'Rijkswaterstaat zou je aannemen!',
  'Je kent je stroomgebieden als de beste!',
  'Daar kan geen dijkdoorbraak tegenop!',
  'Slimmer dan een waterschapsbestuurder!',
  'Je debiet aan kennis is enorm!',
  'De Deltacommissaris is onder de indruk!',
  'Je bent waterdicht voorbereid!',
  'Beter dan een stuw in de Maas!',
  'Je spoelt alle fouten weg!',
  'Daar zit een hoog kennisniveau achter!',
  'Je stroomt door als de Rijn bij Lobith!',
  'Watermanagement-expert in wording!',
  'Je hebt het verhang van deze quiz door!',
  'De Deltawerken zijn niks vergeleken met jouw kennis!',
  'Je navigeert door de stof als water door een bedding!',
  'Sterk als een Oosterscheldekering!',
  'Je waterscheiding is scherp!',
  'Knap! Je kent de drietrapsstrategie!',
  'Je bent de Rijn onder de quizzers!',
  'Daar kan geen hoogwater tegenop!',
  'Aardrijkskundeheld! Ga zo door!',
  'Je scoort hoger dan het waterpeil in januari!',
  'Sterker dan een overloopdijk!',
  'Je meandert niet rond het antwoord!',
  'Top! Je bent klaar voor het proefwerk!',
  'Je kent het verschil tussen Rijn en Maas!',
  'Als een echte hydroloog!',
  'Je retentiebekken van kennis zit vol!',
  'Beter dan een waterschap bij hoogwater!',
  'Je hebt meer kennis dan een dijkgraaf!',
  'Wow, dat ging sneller dan een vloedgolf!',
  'De uiterwaarden buigen voor jouw kennis!',
  'Je bent zowel breedte- als dieptekenner!',
  'Geen twijfel, jij kent je stof!',
  'Je maakt aardrijkskunde-geschiedenis!'
];

const WRONG_MSGS = [
  'Zelfs de Maas overstroomt weleens...',
  'Die kennis is nog even bovenstrooms!',
  'Niet getreurd, ook dijken breken soms door!',
  'Oeps! Maar je leert ervan, net als bij waterbeleid.',
  'De Deltacommissaris had het ook niet geweten...',
  'Geen stress, watermanagement is ook complex!',
  'Foutje! Maar oefening baart een dijkgraaf.',
  'Dat antwoord stroomde de verkeerde kant op!',
  'Je zit even in het diepe, maar je komt boven!',
  'Niet erg, zelfs Rijkswaterstaat maakt fouten.',
  'Au! Maar de volgende vraag gaat beter.',
  'Zelfs de beste hydrologen slaan weleens de plank mis.',
  'Die kennis komt nog, net als het smeltwater in de lente!',
  'Hmm, dat was meer eb dan vloed.',
  'Nog eentje oefenen en je hebt het!',
  'Bijna! Net als een bijna-overstroming.',
  'De uiterwaarden hadden het ook moeilijk!',
  'Dat antwoord had een waterkering nodig.',
  'Niet opgeven! Water slijt ook steen!',
  'Je leert sneller dan een rivier erodeert!',
  'Fout, maar je doorzettingsvermogen is sterker dan een dam!',
  'Ach, morgen weet je het wel!',
  'Dat was een kleine overstroming van fouten, maar je komt terug!',
  'Zelfs de IPCC moet soms bijstellen.',
  'Je zit op het verkeerde stroomgebied, maar je vindt de weg!',
  'Het goede antwoord lag vlakbij, achter de waterscheiding!',
  'Oeps! Maar elke fout is een les.',
  'Die stuw zat even verkeerd, maar we gaan door!',
  'Niet het juiste antwoord, maar wel lef!',
  'De Deltawerken hadden ook herzieningen nodig!',
...
const RESULTS_MSGS = {
  ...
  low: [
    'Niet getreurd! De Deltawerken zijn ook niet in een dag gebouwd.',
...
function updateHomeStats() {
  ...
  if (p.totalAnswered === 0) {
    ...
    el.textContent = `${p.totalAnswered} vragen beantwoord \u2022 ${pct}% goed \u2022 ${badgeCount}/8 badges`;
  }
}
